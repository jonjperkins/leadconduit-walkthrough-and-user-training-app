				...
				<div className="chapter-content-body">
					...
					{this.props.isUsingVendor &&
						<div>
							...
							able to do anything with it.</p>
			 				...
			 				<img className="img-background" src={require('../images/FieldsTab.png')} />
			 				<p>When you created your flow, these 10 fields were added by default:</p>
			 				<img className="img-background" src={require('../images/DefaultFields.png')} />
							...
							<img className="img-background" src={require('../images/AddEditFields.png')} />
							...
							<img id="webform-example" className="img-background" src={require('../images/editingfields.gif')} />
							<br />
							...
							<img className="img-background" id="webform-example" src={require('../images/search_fields.gif')} />
							...
							<img className="img-background" id="webform-example" src={require('../images/custom_fields.png')} />
							...
							<img className="img-background" id="webform-example" src={require('../images/custom_field_modal.png')} />
							...
							<img className="img-background" id="webform-example" src={require('../images/final_field_page.png')} />
					...
					{this.props.isUnbounceUser &&
						<div>
							...
							<img className="img-background" id="webform-example" src={require('../images/field_hat_men.png')} />
							...
							<img className="img-background" id="webform-example" src={require('../images/webform.png')} />
							...
							<img className="img-background" id="webform-example" src={require('../images/field_param_compare.png')} />
							...
							work.</p>
							<img className="img-background" id="webform-example" src={require('../images/editingfields.gif')} />
						</div>
					}
