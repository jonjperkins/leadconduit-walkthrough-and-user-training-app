					...
					<div className="wizard-outer">
						<div className="wizard-inner">
							<div className="wizard-content">
								...
								<Link to="/"><button className="wizard-yes-button" onClick={this.props.handleUnbounceUser} style={{ textDecoration: 'none' }}>Yes</button></Link>
								<Link to="/"><button className="wizard-no-button" onClick={this.props.handleNonUnbounceUser}>No</button></Link>
