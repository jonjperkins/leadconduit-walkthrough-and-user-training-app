				...
				<div className="chapter-content-body">
					...
					{this.props.isUsingVendor &&
						<div>
							...
							refer to a webform you own, or a partner who is generating leads and sending them into your flow.</p>
			 				...
			 				<img className="img-background" src={require('../images/sourcetab.gif')} />
			 				...
			 				<img className="img-background" src={require('../images/addsourcebutton.png')} /> 
			 				...
			 				<img className="img-background" src={require('../images/addstandardsource.gif')} /> 
			 				...
			 				<img className="img-background" src={require('../images/searchsources.gif')} /> 
							...
							<img className="img-background" src={require('../images/customvendor.gif')} />
							...
							<img className="img-background" src={require('../images/editcustomsource.gif')} />
					...
					{this.props.isUnbounceUser &&
						<div>
							...
							<img className="img-background" src={require('../images/unbouncewebformurl.png')} />
							...
							<img className="img-background" src={require('../images/connectunbounceform.png')} />
							<img className="img-background" src={require('../images/unbouncewebformmessage.png')} />
							...
							<img className="img-background" src={require('../images/unbouncefieldmapping.gif')} />
							...
							<img className="img-background" src={require('../images/unbouncesourceadd.png')} />
							...
							<img className="img-background" src={require('../images/unbounceinboundmappings.png')} />
							...
							<img className="img-background" src={require('../images/newlyaddedsource.png')} />
					...
					{this.props.isWebformUser &&
						<div>
							...
							<img className="img-background" src={require('../images/webformurl.png')} />
							...
							<img className="img-background" src={require('../images/selectform.png')} />
							<p>Next, name this source.</p>
							<img className="img-background" src={require('../images/namesource.png')} />
							...
							click Next. </p>
							<img className="img-background" src={require('../images/formaction.png')} />
							...
							<p>We’ll discuss why this is so important later in this guide, but suffice it to say that selecting fields from the dropdown menu 
							at this point (if at all possible) will save you a lot of time in the long run.</p>
							<img className="img-background" src={require('../images/fieldselectionwebformwizard.gif')} />
